import cv2
import numpy as np
from Color.Color_Extraction import hex_to_rgb,extract_colors
...
def drawDominantColors(draw,rect,n=2):
    x1, y1, x2, y2 = rect
...
#
#
# img=cv2.imread('/home/shaheryar/Desktop/Projects/oceans11/inference_results/military_ship_11.jpg')
# img = img[int((400-100)/2 +100):400,100:400]
# cv2.imshow('a',img)
# cv2.waitKey(200000)
